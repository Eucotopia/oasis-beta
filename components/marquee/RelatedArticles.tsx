...
import BrandsScrollingBanner from "@/components/Application/Scrolling-Banners/brands-scrolling-banner/App"
/**
 * 获取当前文章的相关文章
 * @param id
 */
const RelatedArticles = ({id}: { id: number }) => {
    ...
    // console.log(RelatedPost?.data)
    return (
        <>
            <BrandsScrollingBanner/>
