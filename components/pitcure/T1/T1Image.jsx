...
function Card({url, ...props}) {
    ...
    return (
        <Image ref={ref} url={url} transparent side={THREE.DoubleSide} onPointerOver={pointerOver}
               onPointerOut={pointerOut} {...props}>
...
function Banner(props) {
    ...
    return (
        <mesh ref={ref} {...props}>
            ...
            <meshSineMaterial map={texture} map-anisotropy={16} map-repeat={[30, 1]} side={THREE.DoubleSide}
                              toneMapped={false}/>
        </mesh>
    )
}
