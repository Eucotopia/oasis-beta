...
const PlaceListItem = React.forwardRef<HTMLDivElement, PlaceListItemProps>(
    (
        {title, id, likes, rating, isLoading, summary, cover, createTime, removeWrapper, className, ...props},
        ref,
    ) => {
                    ...
                    {isLoading ? (
                        ...
                        <>
                            <div className="flex items-start justify-between gap-1">
                                <h3 className="text-small font-medium text-default-700 line-clamp-1">{title}</h3>
                                {rating !== undefined ? (
                            ...
                            {summary ? <p className="text-small text-default-500 md:line-clamp-3 ">{summary}</p> : null}
