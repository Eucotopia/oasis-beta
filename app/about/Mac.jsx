...
function Model({open, hinge, ...props}) {
    ...
    return (
        <group ref={group} {...props} onPointerOver={(e) => (e.stopPropagation(), setHovered(true))}
               onPointerOut={(e) => setHovered(false)} dispose={null}>
...
export default function App() {
    ...
    return (
        <web.main style={{height: '100vh', width: '50vw', position: 'relative'}}>
            <web.h1 style={{
                color: props.open.to([0, 1], ['bg-white', '#d25578']),
                position: 'absolute', top: '50%', left: '50%',
                opacity: props.open.to([0, 1], [1, 0]),
                fontSize: props.open.to([0, 1], [100, 0]),
