...
const Ship = forwardRef((props, ref) => {
    const {nodes, materials} = useGLTF('/gltf/model.gltf')
    useLayoutEffect(() => {
        Object.values(materials).forEach((material) => {
            material.roughness = 0
        })
    ...
    return (
        <group ref={ref} {...props} dispose={null}>
            ...
            <mesh castShadow receiveShadow geometry={nodes.Cube005_1.geometry} material={materials.Mat1}
                  material-color="black"/>
            <mesh castShadow receiveShadow geometry={nodes.Cube005_2.geometry} material={materials.Mat2}
                  material-envMapIntensity={0.2} material-color="black"/>
...
export default function App() {
    ...
    const ship = useRef()
    return (
        <Canvas shadows camera={{position: [0, 1.5, 3]}} style={{height: '100vh', width: '500px'}}>
            ...
            <Float position={[1, 1.1, -0.5]} rotation={[Math.PI / 3.5, 0, 0]} rotationIntensity={4} floatIntensity={6}
                   speed={1.5}>
                <Spaceman scale={0.2}>
